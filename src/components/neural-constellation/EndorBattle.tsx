  ...
  return (
    <group ref={ref} position={posRef.current}>
      ...
      <mesh position={[0, 0, -1.1]} scale={[1.4, 0.3, 0.3]}>
        ...
        <meshBasicMaterial color="#5599ff" toneMapped={false} transparent opacity={0.8} />
      </mesh>
      {/* Cockpit glow */}
      <mesh position={[1.42, 0.05, 0.78]}>
        <sphereGeometry args={[0.08, 4, 4]} />
        <meshBasicMaterial color="#aaddff" toneMapped={false} transparent opacity={0.6} />
      </mesh>
...
function DeathStar({ position }: { position: [number, number, number] }) {
  ...
  return (
    <group ref={ref} position={position}>
      ...
      <mesh ref={glowRef} position={[2, 2.5, 3.5]}><sphereGeometry args={[1.8, 12, 12]} /><meshBasicMaterial color="#44ff44" toneMapped={false} transparent opacity={0.04} /></mesh>
      ...
      >
        ...
        <meshBasicMaterial color="#44ff44" toneMapped={false} transparent opacity={0} />
      </mesh>
        ...
        <>
          {[-0.4, 0, 0.4].map((zOff, ei) => (
            <mesh key={ei} position={[0, 0, -1.5 * 1.5 + zOff * 0.5]}>
              ...
              <meshBasicMaterial color="#6688ff" toneMapped={false} transparent opacity={0.5} />
            </mesh>
          ))}
        </>
      ) : (
          ...
          {Array.from({ length: 5 }, (_, i) => {
            ...
            return (
              <mesh key={i} position={[-2.4, Math.sin(angle) * 0.3, Math.cos(angle) * 0.3]}>
                ...
                <meshBasicMaterial color="#ff8844" toneMapped={false} transparent opacity={0.6} />
              </mesh>
            );
          })}
        </>
