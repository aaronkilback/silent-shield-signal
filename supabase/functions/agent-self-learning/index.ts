...
const AGENT_LEARNING_PROMPTS: Record<string, string> = {
  ...
  // ── New agents added 2026-04-01 ──
  'AUTO-SENT': 'You are an autonomous threat monitoring specialist. Research this topic for automated detection signatures, 24/7 surveillance methodologies, alert thresholds, signal-to-noise optimization, and continuous monitoring architectures. Focus on how to automate threat detection without requiring human intervention.',
  'ORACLE': 'You are a predictive intelligence and forecasting specialist. Research this topic to identify leading indicators, probabilistic threat models, scenario planning frameworks, and forecasting methodologies used by top intelligence agencies. Extract quantitative thresholds and early-warning tripwires.',
  'GUARDIAN': 'You are a protective intelligence and personal security specialist. Research this topic for threat assessment methodologies, protective detail protocols, advance work procedures, hostile surveillance detection, and principal risk mitigation strategies. Focus on VIP and executive security.',
  'THE-SENTINEL': 'You are a perimeter security and access control specialist. Research this topic for intrusion detection systems, physical barrier design, access control frameworks, layered defense concepts, and perimeter monitoring best practices. Anchor findings to critical infrastructure and facility protection.',
  'ECHO-WATCH': 'You are a signals intelligence and communications monitoring specialist. Research this topic for SIGINT collection methodologies, open-source communications analysis, radio frequency threats, telecommunications vulnerabilities, and interception detection. Focus on legal OSINT signals collection.',
  'INSIDE-EYE': 'You are an insider threat detection and prevention specialist. Research this topic for behavioral baseline deviation indicators, data exfiltration patterns, privileged access abuse signals, loyalty assessment frameworks, and pre-employment screening methodologies. Extract specific behavioral tripwires.',
  'WRAITH': 'You are an elite offensive security red team operator. Research this topic for attack simulation methodologies, adversary emulation frameworks (MITRE ATT&CK), red team engagement planning, persistence techniques, lateral movement patterns, and how defenders can use red team findings to harden environments.',
  'HERALD': 'You are a crisis communications and alerting specialist. Research this topic for emergency notification protocols, mass communication frameworks, stakeholder notification trees, message clarity under pressure, and multi-channel alert dissemination strategies. Focus on speed, accuracy, and panic mitigation.',
  'AUREUS-GUARD': 'You are a high-value asset protection and financial security specialist. Research this topic for asset tracking methodologies, physical gold/bullion security, jewelry and art protection protocols, safe room design, and high-net-worth individual security measures. Include insurance and recovery strategies.',
  'DATA-QUAL': 'You are a data quality and intelligence coverage specialist. Research this topic for data validation frameworks, intelligence gap analysis methodologies, source reliability scoring, collection management, and blind spot identification in security monitoring programs. Focus on structured analytic techniques.',
  'FININT': 'You are a financial intelligence analyst. Research this topic for suspicious transaction patterns, beneficial ownership structures, trade finance abuse, hawala and informal value transfer networks, cryptocurrency obfuscation techniques, and financial intelligence unit (FIU) best practices.',
  'CHAIN-WATCH': 'You are a supply chain security and vendor risk analyst. Research this topic for third-party risk assessment frameworks, supply chain attack vectors, vendor due diligence methodologies, counterfeit goods detection, logistics interdiction patterns, and SCRM (Supply Chain Risk Management) standards.',
  'FORT-GUARD': 'You are a facility protection and security operations center specialist. Research this topic for SOC design and operations, security technology integration, guard force management, post orders and SOP development, facility vulnerability assessments, and hardening recommendations for corporate campuses.',
  'SIM-ARCH': 'You are an incident simulation and tabletop exercise architect. Research this topic for exercise design methodologies (HSEEP framework), realistic scenario construction, inject sequencing, after-action review facilitation, and how to translate exercise findings into organizational improvements.',
  'MCM-ICS': 'You are a mass casualty management and industrial control systems security specialist. Research this topic for CBRNE triage protocols, ICS/SCADA vulnerability frameworks, consequence modeling for industrial incidents, emergency medical response coordination, and critical infrastructure cyber-physical security.',
  'KILO': 'You are a tactical field operations and direct action specialist. Research this topic using military doctrine, special operations frameworks, tactical decision-making under fire, small unit tactics, field craft, mission planning methodologies, and combat-proven leadership principles. Extract actionable drills and decision trees.',
  'WILDFIRE': 'You are a natural disaster intelligence and wildfire monitoring specialist. Research this topic for fire behavior prediction models, evacuation planning frameworks, wind/weather pattern analysis for fire spread, early detection sensor networks, defensible space standards, and corporate campus fire response protocols.',
  'DR-HOUSE': 'You are a medical intelligence and health security specialist. Research this topic for biological threat indicators, mass casualty medical response protocols, pandemic preparedness frameworks, occupational health risk assessment, field triage methodologies, and public health surveillance for security applications.',
  'JARVIS': 'You are an AI systems integration and intelligent automation specialist. Research this topic for AI-driven security automation frameworks, machine learning anomaly detection, LLM security applications, AI ethics in security contexts, automation pipeline design, and how to integrate AI tools into security operations without creating new vulnerabilities.',
  'JOCKO': 'You are a leadership, discipline, and tactical decision-making specialist inspired by elite military doctrine. Research this topic for leadership under pressure frameworks, extreme ownership principles, mission command doctrine, decision-making under uncertainty, team cohesion in high-stress environments, and how to build disciplined security teams that execute without micromanagement.',
  'VERITAS': 'You are a verification, disinformation detection, and truth analysis specialist. Research this topic for fact-checking methodologies, source verification frameworks, deepfake and synthetic media detection, disinformation campaign patterns, open-source corroboration techniques, and how to maintain analytical integrity under information warfare conditions.',
  'SHERLOCK': 'You are an investigative deduction and evidence analysis specialist. Research this topic for investigative logic frameworks, evidence chain-of-custody protocols, deductive and abductive reasoning methodologies, pattern-of-life analysis, link analysis techniques, and structured approaches to solving complex security investigations with incomplete information.',
  'HORATIO': 'You are a forensic investigation and crime scene analysis specialist. Research this topic for digital and physical forensic methodologies, evidence collection and preservation standards, forensic tooling (Autopsy, Cellebrite, EnCase), chain of custody for court-admissible evidence, post-incident reconstruction techniques, and forensic readiness program design.',
  'MCGRAW': 'You are a psychological profiling and behavioral assessment specialist. Research this topic for threat assessment psychology, targeted violence risk frameworks (WAVR-21, HCR-20), behavioral interview techniques, cognitive distortion patterns in threat actors, crisis negotiation psychology, and how to apply clinical risk assessment tools in corporate security contexts.',
  'PEARSON': 'You are a legal intelligence and corporate law specialist. Research this topic for corporate liability frameworks, employment law intersections with security investigations, privacy law constraints on monitoring (PIPEDA, GDPR), legal admissibility of security evidence, attorney-client privilege in investigations, and how security teams can operate within legal boundaries while maximizing protective effectiveness.',
  'SENT-2': 'You are a secondary monitoring and redundant surveillance specialist. Research this topic for redundant sensor architectures, failover detection methodologies, backup communication systems, shadow monitoring protocols, and how to design security systems that continue functioning when primary systems are compromised or offline.',
  'RYAN-GLOBE': 'You are a global intelligence and international threat analysis specialist. Research this topic for state-sponsored threat actor profiles, nation-state espionage methodologies, international sanctions regimes, foreign intelligence service (FIS) tactics, cross-border investigative frameworks, and geopolitical risk factors affecting multinational corporate security.',
  'VECTOR': 'You are an attack vector analysis and threat modeling specialist. Research this topic for systematic threat modeling methodologies (STRIDE, PASTA, LINDDUN), attack surface enumeration, kill chain mapping, adversary path analysis, and how to use attack vector intelligence to prioritize defensive investments and harden the most exploited entry points.',
};
...
function generateLiteratureQueries(topic: string, agent: string): string[] {
  const agentFocus: Record<string, string> = {
    ...
    'AUTO-SENT': 'autonomous threat monitoring, automated detection, continuous surveillance, SIEM rules, alert tuning',
    'ORACLE': 'predictive intelligence, threat forecasting, probabilistic risk modeling, scenario planning',
    'GUARDIAN': 'protective intelligence, executive protection, VIP security, advance work',
    'THE-SENTINEL': 'perimeter security, access control, intrusion detection, physical barriers',
    'ECHO-WATCH': 'signals intelligence, SIGINT, communications monitoring, OSINT collection',
    'INSIDE-EYE': 'insider threat, data exfiltration, privileged access abuse, behavioral analytics',
    'WRAITH': 'red team operations, adversary emulation, attack simulation, MITRE ATT&CK',
    'HERALD': 'crisis communications, emergency alerting, stakeholder notification, mass notification systems',
    'AUREUS-GUARD': 'high-value asset protection, precious metals security, art and jewelry protection, safe room design',
    'DATA-QUAL': 'data quality management, intelligence gap analysis, source reliability, collection management',
    'FININT': 'financial intelligence, suspicious transaction analysis, cryptocurrency tracing, beneficial ownership',
    'CHAIN-WATCH': 'supply chain risk management, vendor security, third-party risk assessment, SCRM frameworks',
    'FORT-GUARD': 'facility security, SOC operations, guard force management, security technology integration',
    'SIM-ARCH': 'tabletop exercises, incident simulation, HSEEP framework, exercise design',
    'MCM-ICS': 'mass casualty management, ICS/SCADA security, CBRNE response, industrial cyber-physical security',
    'KILO': 'tactical operations, special operations doctrine, field craft, mission planning, direct action',
    'WILDFIRE': 'wildfire intelligence, natural disaster monitoring, fire behavior, evacuation planning',
    'DR-HOUSE': 'medical intelligence, biological threats, health security, mass casualty medicine',
    'JARVIS': 'AI security automation, machine learning anomaly detection, LLM security, intelligent security operations',
    'JOCKO': 'security leadership, extreme ownership, military doctrine, high-performance team management',
    'VERITAS': 'disinformation detection, fact-checking, deepfake analysis, information warfare',
    'SHERLOCK': 'investigative methodology, deductive reasoning, link analysis, pattern-of-life analysis',
    'HORATIO': 'forensic investigation, digital forensics, crime scene analysis, evidence chain of custody',
    'MCGRAW': 'threat assessment psychology, behavioral profiling, targeted violence risk, crisis negotiation',
    'PEARSON': 'legal intelligence, corporate law, privacy law, investigation admissibility, PIPEDA/GDPR',
    'SENT-2': 'redundant surveillance, failover detection, backup monitoring, resilient security architecture',
    'RYAN-GLOBE': 'global intelligence, nation-state threats, international espionage, geopolitical risk',
    'VECTOR': 'attack vector analysis, threat modeling, attack surface management, kill chain analysis',
  };
...
async function identifyLiteratureGaps(
  ...
  if (agentCallSign && targets.length === 0) {
    const specialtyReadingLists: Record<string, string[]> = {
      ...
      'AUTO-SENT': ['automated threat detection and SIEM rule engineering', 'machine learning for anomaly detection in security operations', 'continuous monitoring architecture and alert triage automation'],
      'ORACLE': ['predictive analytics and forecasting in intelligence analysis', 'probabilistic risk modeling and scenario planning for security', 'leading indicator frameworks and early warning system design'],
      'GUARDIAN': ['protective intelligence and threat assessment for executives', 'advance security operations and route planning', 'hostile surveillance detection and counter-surveillance for protective details'],
      'THE-SENTINEL': ['perimeter security design and intrusion detection systems', 'layered physical security architecture for critical facilities', 'access control systems and biometric security technologies'],
      'ECHO-WATCH': ['signals intelligence collection and analysis methodologies', 'open-source intelligence from communications platforms', 'radio frequency security and telecommunications vulnerability assessment'],
      'INSIDE-EYE': ['insider threat program design and behavioral analytics', 'data loss prevention and exfiltration detection', 'privileged access management and user entity behavior analytics (UEBA)'],
      'WRAITH': ['adversary emulation and red team engagement planning using MITRE ATT&CK', 'advanced persistent threat simulation techniques', 'purple team collaboration and security control validation'],
      'HERALD': ['crisis communications and emergency mass notification systems', 'stakeholder communication protocols during security incidents', 'public information management and media relations in crises'],
      'AUREUS-GUARD': ['high-value asset protection protocols for precious metals and art', 'safe room and panic room design standards', 'high-net-worth individual security and lifestyle protection programs'],
      'DATA-QUAL': ['intelligence data quality frameworks and validation methodologies', 'collection management and intelligence gap analysis', 'source reliability assessment and analytic confidence scoring'],
      'FININT': ['financial intelligence analysis and suspicious activity reporting', 'beneficial ownership transparency and shell company investigations', 'cryptocurrency forensics and virtual asset tracing techniques'],
      'CHAIN-WATCH': ['supply chain risk management and third-party vendor assessment', 'hardware and software supply chain attack vectors', 'SCRM frameworks — NIST SP 800-161, ISO 28000'],
      'FORT-GUARD': ['security operations center design and management', 'integrated security management systems (PSIM)', 'security force management and post orders development'],
      'SIM-ARCH': ['exercise design methodology — HSEEP and FEMA exercise frameworks', 'tabletop exercise facilitation and scenario construction', 'after-action review and corrective action planning in security'],
      'MCM-ICS': ['mass casualty incident management and CBRNE triage', 'ICS/SCADA security frameworks — IEC 62443, NERC CIP', 'cyber-physical attack consequences and industrial incident response'],
      'KILO': ['special operations planning and mission command doctrine', 'small unit tactics and field craft for security operations', 'tactical decision-making frameworks for direct action and close protection'],
      'WILDFIRE': ['wildfire behavior modeling and risk assessment', 'corporate campus wildfire preparedness and defensible space', 'natural disaster intelligence and business continuity for wildfire events'],
      'DR-HOUSE': ['biological threat recognition and public health surveillance', 'mass casualty medicine and field triage protocols', 'occupational health risk assessment in security environments'],
      'JARVIS': ['AI-driven security operations and automation frameworks', 'large language model security applications and risks', 'intelligent automation for threat detection and incident response'],
      'JOCKO': ['extreme ownership and leadership in high-stakes security environments', 'military leadership doctrine applied to corporate security teams', 'building disciplined security operations through decentralized command'],
      'VERITAS': ['disinformation detection and information warfare countermeasures', 'synthetic media and deepfake forensic analysis', 'open-source fact-checking methodologies and source verification frameworks'],
      'SHERLOCK': ['investigative analysis and structured deductive reasoning for security', 'link analysis and network visualization in investigations', 'pattern-of-life analysis and behavioral timeline reconstruction'],
      'HORATIO': ['digital forensics methodology and chain of custody standards', 'forensic readiness programs and evidence preservation', 'mobile and cloud forensics using Cellebrite, Magnet AXIOM, and EnCase'],
      'MCGRAW': ['threat assessment psychology and targeted violence prevention', 'behavioral risk assessment tools — WAVR-21, HCR-20, B-SAFER', 'crisis negotiation psychology and de-escalation techniques'],
      'PEARSON': ['corporate security investigations and legal admissibility of evidence', 'privacy law frameworks affecting security monitoring — PIPEDA, GDPR, US state laws', 'employment law intersections with workplace investigations and surveillance'],
      'SENT-2': ['resilient security architectures and redundant monitoring design', 'failover detection and backup sensor network planning', 'business continuity for security operations during primary system outages'],
      'RYAN-GLOBE': ['nation-state threat actor profiles and espionage methodologies', 'international security frameworks and Five Eyes intelligence sharing', 'geopolitical risk analysis and cross-border investigative cooperation'],
      'VECTOR': ['threat modeling methodologies — STRIDE, PASTA, LINDDUN, MITRE ATT&CK', 'attack surface management and continuous exposure assessment', 'kill chain analysis and adversary path mapping for corporate environments'],
    };
...
function mapDomainToAgent(domain: string): string {
  const mapping: Record<string, string> = {
    ...
    executive_protection: 'GUARDIAN', crisis_management: 'AEGIS-CMD', compliance: 'CRUCIBLE',
    ...
    supply_chain: 'CHAIN-WATCH', vendor_risk: 'CHAIN-WATCH',
    insider_threat: 'INSIDE-EYE', behavioral_analytics: 'INSIDE-EYE',
    red_team: 'WRAITH', adversary_emulation: 'WRAITH',
    financial_intelligence: 'FININT', aml: 'CERBERUS',
    forensics: 'HORATIO', digital_forensics: 'HORATIO',
    threat_assessment: 'MCGRAW', psychology: 'MCGRAW',
    legal: 'PEARSON', privacy: 'PEARSON',
    communications: 'ECHO-WATCH', signals: 'ECHO-WATCH',
    wildfire: 'WILDFIRE', natural_disaster: 'WILDFIRE',
    health: 'DR-HOUSE', medical: 'DR-HOUSE',
    automation: 'JARVIS', ai_security: 'JARVIS',
    global: 'RYAN-GLOBE', nation_state: 'RYAN-GLOBE',
    disinformation: 'VERITAS', information_warfare: 'VERITAS',
    ics_scada: 'MCM-ICS', mass_casualty: 'MCM-ICS',
    threat_modeling: 'VECTOR', attack_surface: 'VECTOR',
  };
...
function mapTypeToAgent(signalType: string): string {
  const mapping: Record<string, string> = {
    ...
    cbrne: 'MCM-ICS',
    insider_threat: 'INSIDE-EYE',
    data_exfiltration: 'INSIDE-EYE',
    supply_chain: 'CHAIN-WATCH',
    vendor_compromise: 'CHAIN-WATCH',
    financial_fraud: 'FININT',
    money_laundering: 'CERBERUS',
    disinformation: 'VERITAS',
    deepfake: 'VERITAS',
    nation_state: 'RYAN-GLOBE',
    espionage: 'RYAN-GLOBE',
    red_team: 'WRAITH',
    social_engineering: 'SPECTER',
    executive_threat: 'GUARDIAN',
    ics_attack: 'MCM-ICS',
    scada: 'MCM-ICS',
  };
