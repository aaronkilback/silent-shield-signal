...
`.trim();
    ...
    if (isCyberAdvisory) {
      ...
      systemPrompt =
        ...
        `- Be specific. "The client operates critical infrastructure" is too generic to elevate. "The client's high_value_assets list includes ConnectWise ScreenConnect, advisory CVE-2024-1708 affects exactly that product" is correct.`;
